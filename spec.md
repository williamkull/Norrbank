...
From intent.md (ONB-2140). Accepted by E. Sandberg, product owner, RM workspace.
...
**Resolved** — E. Sandberg, with the AML policy owner and O. Haddad consulted: show both.
Plain wording as the stage, the procedure code beneath it in a secondary line.
...
**Resolved** — data-protection owner: date only. The name is stripped at the projection,
not at the panel.
...
**Resolved** — E. Sandberg: out of scope for this change. Recorded as a candidate for a
separate intent.md.

## Out of scope

- Client-facing visibility in the corporate portal (C3).
